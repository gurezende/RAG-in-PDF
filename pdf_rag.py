...
if __name__ == "__main__":
    ...
    # File
    path = "C:/Users/gurez/OneDrive/Área de Trabalho/Create an AI Agent with RAG in Two Simple Steps.pdf"
    
    # Prompt
    prompt = "What are the steps to build a RAG?"

    # Create class instance
    rag_agent = RAGPDF(collection_name="rag_pdf")
    ...
    # Create agent
    agent = rag_agent.create_agent(knowledge_base)
